...
# Adventure Game
items = input("You are walking through the dark forest and find three items: a MATCH, TENT and a FLASHLIGHT. Which one do you want to pick up? ")
...
# Tent
elif items.lower() == "tent":
    tent = input("You pick up the tent. Do you  want to BRING it back to camp or SET IT UP? ")

    print()

    if tent.lower() == "bring":
        print("Tell your friends that you found it in the middle of the forest. \n")

    elif tent.lower() == "set it up":
        print("Lay the base, spread out and stake your tent, add the poles, raise the tent, add the rainfly, and add final stakes and supports. \n")
